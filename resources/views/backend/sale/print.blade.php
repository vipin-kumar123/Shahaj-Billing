    ...
    <div id="print-area">
            ...
            <tr>
                ...
                <td>
                    <table style="width:100%;">
                        <tr>
                            <td>Sub Total:</td>
                            <td class="text-right">{{ moneyFormat($sale->subtotal, 2) }}</td>
                        </tr>
                        <tr>
                            <td>Discount:</td>
                            <td class="text-right">{{ moneyFormat($sale->discount_amount ?? 0, 2) }}</td>
                        </tr>
                        <tr>
                            <td>Tax:</td>
                            <td class="text-right">{{ moneyFormat($sale->tax_amount, 2) }}</td>
                        </tr>
                        <tr>
                            <td><strong>Grand Total:</strong></td>
                            <td class="text-right"><strong>{{ moneyFormat($sale->total_amount, 2) }}</strong></td>
                        </tr>
                        <tr>
                            <td>Paid:</td>
                            <td class="text-right">{{ moneyFormat($sale->paid_amount, 2) }}</td>
                        </tr>
                        <tr>
                            <td>Balance:</td>
                            <td class="text-right">{{ moneyFormat($sale->due_amount, 2) }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <table>
            ...
            <tr style="text-align: center">
                ...
                <td>{{ moneyFormat($sale->subtotal, 2) }}</td>
                <td>{{ moneyFormat($sale->tax_amount / 2, 2) }}</td>
                <td>{{ moneyFormat($sale->tax_amount / 2, 2) }}</td>
                <td>0.00</td>
                <td>{{ moneyFormat($sale->tax_amount, 2) }}</td>
            </tr>
        </table>
