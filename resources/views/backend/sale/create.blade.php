    ...
    <div class="container-fluid px-2">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
            <div class="d-flex align-items-center text-muted small flex-wrap">
                ...
                <i class="bi bi-chevron-right mx-2"></i>
                <span class="fw-semibold text-dark">Create Sale</span>
            </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body px-4 py-4">
                ...
                <form id="saleForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" value="SL/" disabled>
                    ...
                    <button type="submit" id="addSaleBtn" class="mdc-button mdc-button--unelevated px-5">
...
@push('footer-script')
    <script>
        window.PURCHASE_STORE_ROUTE = "{{ route('sale.store') }}";
    </script>
