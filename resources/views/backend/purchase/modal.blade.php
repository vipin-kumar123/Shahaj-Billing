...
{{-- make payment modal  --}}
<div class="modal fade pop-out" id="paymentModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-sm">

            <!-- HEADER -->
            <div class="modal-header">
                <h5 class="modal-title fw-semibold">Make Payment</h5>
            ...
            <form id="makePaymentForm" method="post">
                <div class="modal-body">
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        ...
                        <button type="submit" id="makePaymentBtn" class="mdc-button mdc-button--unelevated px-4">
