...
@section('title')
    Billing Software | Purchase Return
@endsection
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="return_qty[{{ $item->id }}]"
                                                class="form-control return-qty" data-cost="{{ $item->unit_cost }}"
                                                data-gst="{{ $item->gst_percent }}" max="{{ $item->quantity }}"
...
@push('footer-script')
    <script>
        window.PURCHASE_RETURN_STORE_ROUTE =
            "{{ route('purchase.return.store', $purchase->id) }}";

        window.PURCHASE_RETURN_INDEX_ROUTE =
