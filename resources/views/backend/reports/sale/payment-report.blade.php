...
@section('title')
    Billing Software | Sale Payment Reports
@endsection
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
            <div class="d-flex align-items-center text-muted small flex-wrap">
                ...
                <span>Sale Payment Reports</span>
                <i class="bi bi-chevron-right mx-2"></i>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body">
                <form method="post" action="{{ route('reports.payment.submit') }}">
                    @csrf
                    <h6 class="mb-3">Sale Payment Reports</h6>
                    <hr>
                    <div class="row g-3">
                        <div class="col-md-4">
