...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <a href="{{ route('roles.create') }}" class="mdc-button mdc-button--unelevated">
                + Add Roles
            </a>
        </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-2">
                ...
                <table id="roleTable" class="table table-hover mb-0" style="width:100%; table-layout: fixed;">
