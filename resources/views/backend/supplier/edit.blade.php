...
@section('title')
    Billing Software | Edit Supplier
@endsection
    ...
    <div class="container-fluid px-2">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
            ...
            <div class="d-flex align-items-center text-muted small flex-wrap">
                ...
                <i class="bi bi-chevron-right mx-2"></i>
                <span class="fw-semibold text-dark">Edit Supplier</span>
            </div>

            <!-- RIGHT -->
            <div class="d-flex gap-2 mt-2 mt-md-0">
                <a href="{{ route('supplier.index') }}" class="mdc-button mdc-button--danger btn-sm">
            ...
            <div class="card-body px-5 py-3">
                ...
                <form method="POST" action="{{ route('supplier.update', $supplier->id) }}">
                        ...
                        <div class="tab-pane fade show active" id="addressTab">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="state" id="state_id" class="form-control select2">
                                        ...
                                        @forelse ($state as $s)
                                            <option value="{{ $s->id }}"
                                                {{ old('state', $supplier->state ?? '') == $s->id ? 'selected' : '' }}>
                                                {{ $s->name }}
                                            </option>
                                        @empty
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <textarea name="billing_address" class="form-control">{{ old('billing_address', $supplier->billing_address) }} </textarea>
                                </div>

                                <div class="col-md-6">
                                    <label class="form-label">Shipping Address</label>
                                    <textarea name="shipping_address" class="form-control">{{ old('shipping_address', $supplier->shipping_address) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="checkbox" name="is_business" value="1"
                                        {{ $supplier->is_business == 1 ? 'checked' : '' }}>
                                </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="udhar_limit" class="form-control"
                                        value="{{ old('udhar_limit', $supplier->udhar_limit ?? 0) }}">
                                </div>
                    ...
                    <div class="mt-4">
                        ...
                        <a href="{{ route('supplier.index') }}" class="btn btn-light">Close</a>
                    </div>
                </form>
...
@push('footer-script')
    <script>
        window.SUPPLIER_STATE_GET_CITY = "{{ route('supplier.stateGetCity') }}";
        window.SELECTED_STATE_ID = "{{ $supplier->state ?? 0 }}";
        window.SELECTED_CITY_ID = "{{ $supplier->city ?? 0 }}";
    </script>
